...
# ── Rule engine imports (extracted to core/rules/ + core/agent_migrations.py) ──
from core.rules import (
    RuleCategory, PriorityLevel, Enforcement, Rule,
    CATEGORY_CHECK_ORDER, CATEGORY_DEFAULT_PRIORITY, AdvancedRuleChecker,
)
from core.agent_migrations import (
    CURRENT_MIGRATION_VERSION, MIGRATIONS, GLOBAL_COMPLIANCE_RULE,
    _migrate_add_subtree_session, _migrate_add_enabled_toolsets,
    _migrate_add_critical_rules, _migrate_add_llm_params,
    _migrate_upgrade_agent_toolsets, _migrate_auto_upgrade_20260617,
    _migrate_add_strict_compliance,
)
