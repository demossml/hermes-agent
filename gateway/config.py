    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            if isinstance(telegram_cfg, dict):
                ...
                frcs = telegram_cfg.get("free_response_chats_strict")
                if frcs is not None and not os.getenv("TELEGRAM_FREE_RESPONSE_CHATS_STRICT"):
                    os.environ["TELEGRAM_FREE_RESPONSE_CHATS_STRICT"] = str(frcs).lower()
                ...
                for _telegram_extra_key in ("guest_mode", "disable_link_previews", "observe_unmentioned_group_messages", "use_api_10_markup"):
