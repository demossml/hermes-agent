...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("agents", "Show active agents and running tasks", "Session",
               aliases=("tasks",)),
    CommandDef("watch", "Monitor agent activity: /watch <agent>|all|off", "Session",
               aliases=("monitor",), args_hint="[agent|all|off]", cli_only=True),
    ...
    CommandDef("status", "Show session, model, token, and agent activity info", "Session"),
    CommandDef("whoami", "Show your slash command access (admin / user)", "Info"),
    CommandDef("profile", "Show active profile, home directory, and DB path. /profile status", "Info"),
    ...
    CommandDef("insights", "Show shared project insights: /insights [N]", "Project", aliases=("insi",), args_hint="[N]"),
CommandDef("insight", "Manage shared insights: /insight add|search|recent <args>", "Project", aliases=("ins",), args_hint="add|search|recent <args>"),
